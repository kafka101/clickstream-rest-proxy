...
public final class AvroTranslator {
    ...
    private <T, R extends GenericContainer> R toAvro(T object, Schema schema) {
        try {
            ...
            throw new AvroException("Could not translate Object to GenericContainer: " + ex.getMessage(), ex);
        }
    }
    ...
    private <T extends GenericContainer, R> R toObject(T avro, Schema schema) {
        try {
            ...
            throw new AvroException("Could not translate GenericContainer to Object: " + ex.getMessage(), ex);
        }
    }
}